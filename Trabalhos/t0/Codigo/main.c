...
static void cria_hardware(hardware_t *hw)
{
  ...
  // cria o dispositivo de random
  hw->random = random_cria();
  ...
  es_registra_dispositivo(hw->es, D_RANDOM_ESCREVE, hw->random, 0, random_leitura, NULL);
